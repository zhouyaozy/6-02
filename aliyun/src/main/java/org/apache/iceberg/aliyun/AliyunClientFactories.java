...
public class AliyunClientFactories {
  ...
  static class DefaultAliyunClientFactory implements AliyunClientFactory {
    ...
    private volatile OIDCRoleArnCredentialProvider rrsaCredentialProvider;
    ...
    private OIDCRoleArnCredentialProvider getOrCreateRrsaProvider() {
    ...
    public OSS newOSSClient() {
      ...
      if (isRrsaEnvironmentAvailable()) {
        try {
          ...
          OIDCRoleArnCredentialProvider oidcProvider = getOrCreateRrsaProvider();
